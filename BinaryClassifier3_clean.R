...
#########################
## Set directory
setwd("/Users/dtr5a/Documents/DataScience/LogisticRegressionSetup/i360Project")
...
write.csv(training, 'ProjectFiles/trainingF.csv')
write.csv(testing[,names(training)], 'ProjectFiles/testingF.csv')
write.csv(trainingDum, 'ProjectFiles/trainingF_dum.csv')

# # Examine correlations
# #Spearman correlations here
# library(PerformanceAnalytics)
# chart.Correlation(training[,numVars[1:2]], 
#                   method="spearman",
#                   histogram=TRUE,
#                   pch=16)
# library(psych)
# corr.test(training[,numVars[,1:20]], 
#           use = "pairwise",
#           method="spearman",
